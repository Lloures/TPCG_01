...
})({"iDy6d":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "d9ec08d9199053a2";
"use strict";
...
},{}],"jFfAD":[function(require,module,exports,__globalThis) {
window.onload = ()=>{
    ...
    function drawStoredShapes(clearCanvas = true) {
        ...
        if (recorteRect && recorteAtivado) {
            ...
            context?.beginPath();
            context?.rect(Math.min(recorteRect.x1, recorteRect.x2), Math.min(recorteRect.y1, recorteRect.y2), Math.abs(recorteRect.x2 - recorteRect.x1), Math.abs(recorteRect.y2 - recorteRect.y1));
            context?.stroke();
            context.setLineDash([]);
        }
    }
...
},{}]},["iDy6d","jFfAD"], "jFfAD", "parcelRequire4487")

//# sourceMappingURL=meu-projeto.199053a2.js.map
